...
import { Link, usePage } from '@inertiajs/inertia-react'; // Import usePage from Inertia
import SidebarLinkGroup from './SidebarLinkGroup';
import Logo from '../../../images/logo/logo.svg';
import clsx from 'clsx';

const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  const { url: pathname } = usePage();  // Use Inertia's usePage to access the current URL
  ...
  // Update localStorage and body class for sidebar state
  useEffect(() => {
                  ...
                  <>
                    <Link
                      ...
                      className={clsx(
                        ...
                        {
                          'bg-graydark dark:bg-meta-4': pathname === '/category' || pathname.includes('/category'),
                        }
                      )}
                      onClick={(e) => {
                        e.preventDefault();
                    ...
                    <div className={clsx('translate transform overflow-hidden', { hidden: !open })}>
                      <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                        <li>
                          <Link
                            href="/category/manage-category"
                            className={clsx(
                              'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white',
                              { '!text-white': pathname === '/category/manage-category' }
                            )}
                          >
                            Manage Category
                          </Link>
                        ...
                        <li>
                          <Link
                            href="/category/category-orders"
                            className={clsx(
                              'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white',
                              { '!text-white': pathname === '/category/category-orders' }
                            )}
                          >
                            Category Orders
                          </Link>
